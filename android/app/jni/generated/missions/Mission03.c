//
//  C:\Users\marco\Desktop\gardens-of-kadesh-master\android\app\jni\generated\missions\Mission03.c
//
...
//  All rights reserved
//
//  This code was autogenerated from Mission03.kp by KAS2C Version 2.06noleak
//


#include "C:\Users\marco\Desktop\gardens-of-kadesh-master\android\app\jni\generated\missions\Mission03.h"  // prototypes and #includes for exposed game functions
...
void Watch_Mission03_ImNotHere_WatchForFrigates(void)
{
	CurrentMissionScope = KAS_SCOPE_STATE;
	strcpy(CurrentMissionScopeName, kasThisTeamPtr->kasLabel);
	if (((sdword)kasfRenderedShips(kasAITeamShipsPtr("EnemyFrig01"), 4)) || ((sdword)kasfRenderedShips(kasAITeamShipsPtr("EnemyFrig02"), 4)) || ((sdword)kasfRenderedShips(kasAITeamShipsPtr("ImNotDeadYet"), 4)))
	{
