...
/* Android: desktop/legacy GL is provided by gl4es (translates GL 1.x/2.x to
   GLES2 at runtime). gl4es exposes real gl* symbols, so we must NOT declare
   the desktop extern function pointers used on other platforms. */
#include <GL/gl.h>
#include <GL/glext.h>
